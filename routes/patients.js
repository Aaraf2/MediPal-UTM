...
router.get("/login", (req, res) => {
  res.render("login", { title: "MediPal UTM", message: req.flash("message") });
});
...
router.get("/bookappointments", (req, res) => {
  res.render("bookAppointmentPage", {
    title: "MediPal UTM",
...
router.get(
  ...
  prescriptionController.findpatientprescriptions
);

router.get(
  "/viewpatientprescription/:id",
